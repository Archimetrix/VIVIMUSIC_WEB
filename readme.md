...
**🔴This extension require good amount of ram like 1gb max and some graphics  for example if you have a littlebit gpu even windows intregated gpu thats also can run this just make sure that graphics acceleration is turn on in your browser its very important .its actively themeing live website so system resource is essential-think of it like you running a software basically**
